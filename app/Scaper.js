...
document.addEventListener("click", function (e) {
                ...
                if (theadChild.tagName == "TR") {
                    ...
                    if (isHeaderRow) {
                        ...
                        for (var header of headers) {
                            ...
                            let headerLeafs = $(header).find(':not(:has(*))').filter(function () { return $(this).css('display') != 'none'; });
    ...
    electron_1.ipcRenderer.sendToHost("click", tableHtml, newHtml);
});
//# sourceMappingURL=Scaper.js.map